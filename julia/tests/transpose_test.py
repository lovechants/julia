...
def test_transpose_method():
    ...
    placeholder = graph.add_placeholder(
        shape=(3, 4), dtype=DataType.FLOAT32, name="placeholder"
    )
    ...
    op_node = IRNode(op_type="Add", inputs=[placeholder, const_node], name="add")
    op_node.shape = (3, 4)
