...
from julia.core.nn.layers import Linear, Flatten, Dropout, Sequential, BatchNorm2D, Layer
...
class CNNTestModel(Sequential):
    ...
    def __init__(self, in_channels=3, num_classes=10):
        ...
        conv1 = Conv2D(in_channels=in_channels, out_channels=16, kernel_size=3, padding=1)
        ...
        flatten = Flatten()
        fc1 = Linear(32 * 8 * 8, 128)  # Assuming 32x32 input -> 8x8 after pooling layers
