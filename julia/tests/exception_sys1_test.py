...
class TestJuliaErrorBase:
    ...
    def test_error_with_all_parameters(self):
        ...
        context = ErrorContext(
            operation="test_op", tensor_shapes=[(3, 4), (2, 2)], layer_name="test_layer"
        )
...
class TestTensorErrors:
    ...
    def test_shape_error_with_suggestions(self):
        ...
        assert (
            "reshape" in error.suggestion.lower() or "view" in error.suggestion.lower()
        )
    ...
    def test_shape_error_broadcast_suggestion(self):
        ...
        error = ShapeError(
            "Addition failed", expected_shape=(3, 1, 4), actual_shape=(3, 2, 4)
        )
    ...
    def test_dtype_error(self):
        ...
        error = DTypeError(
            "Type mismatch", expected_dtype="float32", actual_dtype="int64"
        )
    ...
    def test_device_error(self):
        ...
        error = DeviceError(
            "Device mismatch", expected_device="cuda", actual_device="cpu"
        )
...
class TestModelErrors:
    ...
    def test_layer_error(self):
        ...
        error = LayerError(
            "Forward pass failed", layer_name="conv1", layer_type="Conv2D"
        )
...
class TestErrorRecovery:
    ...
    def test_safe_tensor_operation_non_recoverable_error(self):
        ...
        with pytest.raises(JuliaError):
            ErrorRecovery.safe_tensor_operation(failing_op, 2, 3, fallback=fallback_op)
...
class TestErrorConfiguration:
    ...
    def test_error_config_modification(self):
        ...
        config = ErrorConfig()
        config.configure(show_suggestions=False, auto_recovery=True, max_tensor_info=10)
    ...
    def test_global_config_function(self):
        ...
        configure_error_handling(show_context=False, performance_warnings=False)
...
class TestIntegrationScenarios:
    ...
    def test_memory_error_with_context(self):
        ...
        error = MemoryError(
            "GPU out of memory during matrix multiplication", context=context
        )
