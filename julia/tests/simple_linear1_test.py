...
class TestLinearLayer(unittest.TestCase):
    def test_linear_forward_backward(self):
        ...
        linear.weight = Tensor(
            np.ones((out_features, in_features)) * 0.1, requires_grad=True
        )
